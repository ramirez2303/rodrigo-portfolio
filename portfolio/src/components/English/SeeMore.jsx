      ...
      >
        ...
        >
          ...
          >
            ...
            <ProjectCard
              id="project4"
              title="Chat App Ilustration in CSS"
              image={project4}
              alt="Project 4 Image - Chat App"
              text={`A presentation of a chat app, the ilustration of the app is make with Css, based in the challenge of Frontend Mentor`}
            ...
            <ProjectCard
              ...
              text={`A landing page for a social media, based in the challenge of Frontend Mentor`}
            ...
            <ProjectCard
              id="project6"
              title="Subscription Music App"
              image={project6}
              alt="Project 6 Image - Music App"
              text={`Music app purchase summary, based in the challenge of Frontend Mentor`}
